...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Change Healthcare Professional Claims API (Unofficial)}
  spec.description   = %q{Provides a nicely-wrapped generated swagger client for CHC's professional claims API v3}
