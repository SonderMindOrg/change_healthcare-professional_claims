...
module ChangeHealthcare
  module ProfessionalClaims
    module SwaggerClient
      class DurableMedicalEquipmentService
        attr_accessor :days, :purchase_price, :rental_price

        # notes
        attr_accessor :frequency_code
        ...
        # @param [Object] frequency_code Object to be assigned
        def frequency_code=(frequency_code)
          validator = EnumAttributeValidator.new('String', %w[1 4 6])
          unless validator.valid?(frequency_code)
            raise ArgumentError,
                  %(invalid value for "frequency_code", must be one of #{validator.allowable_values}.)
          end
