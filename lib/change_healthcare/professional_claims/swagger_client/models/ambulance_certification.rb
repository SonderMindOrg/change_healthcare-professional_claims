    ...
    module SwaggerClient
      class AmbulanceCertification
        ...
        def initialize(attributes = {})
          ...
          return unless attributes.key?(:conditionCodes) && (value = attributes[:conditionCodes]).is_a?(Array)
        ...
        # @param certification_condition_indicator ['N','Y'] to be assigned
        ...
        def hash
          [certification_condition_indicator, condition_codes].hash
        end
