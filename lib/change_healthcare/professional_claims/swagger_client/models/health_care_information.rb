  ...
  module ProfessionalClaims
    module SwaggerClient
      class HealthCareInformation
        ...
        attr_accessor :diagnosis_type_code
        ...
        # @param [Object] diagnosis_type_code Object to be assigned
        def diagnosis_type_code=(diagnosis_type_code)
          validator = EnumAttributeValidator.new('String', %w[BK ABK BF ABF])
          unless validator.valid?(diagnosis_type_code)
            raise ArgumentError,
                  %(invalid value for "diagnosis_type_code", must be one of #{validator.allowable_values}.)
          end
