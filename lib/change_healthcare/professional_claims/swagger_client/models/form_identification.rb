  ...
  module ProfessionalClaims
    module SwaggerClient
      class FormIdentification
        attr_accessor :form_identifier, :supporting_documentation
        ...
        # @param [Object] form_type_code Object to be assigned
        def form_type_code=(form_type_code)
          validator = EnumAttributeValidator.new('String', %w[AS UT])
          unless validator.valid?(form_type_code)
            raise ArgumentError,
                  %(invalid value for "form_type_code", must be one of #{validator.allowable_values}.)
          end
