...
module ChangeHealthcare
  module ProfessionalClaims
    module SwaggerClient
      class Address
        attr_accessor :address1, :address2, :city, :country_code, :country_sub_division_code, :postal_code, :state
        ...
        def initialize(attributes = {})
          ...
          self.country_code = attributes[:countryCode] if attributes.key?(:countryCode)

          self.country_sub_division_code = attributes[:countrySubDivisionCode] if attributes.key?(:countrySubDivisionCode)
        ...
        def ==(other)
          ...
          self.class == other.class &&
            ...
            country_sub_division_code == other.country_sub_division_code &&
        ...
        def hash
          [address1, address2, city, country_code, country_sub_division_code, postal_code, state].hash
        end
