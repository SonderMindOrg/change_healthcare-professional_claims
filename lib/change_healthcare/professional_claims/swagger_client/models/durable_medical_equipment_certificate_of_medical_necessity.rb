...
module ChangeHealthcare
  module ProfessionalClaims
    module SwaggerClient
      class DurableMedicalEquipmentCertificateOfMedicalNecessity
        # Allowed Values are: 'AB' Previously Submitted to Payer, 'AD' Certification Included in this Claim, 'AF' Narrative Segment Included in this Claim, 'AG' No Documentation is Required, 'NS' Not Specified
        ...
        def valid?
          attachment_transmission_code_validator = EnumAttributeValidator.new('String', %w[AB AD AF AG NS])
        ...
        def attachment_transmission_code=(attachment_transmission_code)
          validator = EnumAttributeValidator.new('String', %w[AB AD AF AG NS])
        ...
        def hash
          [attachment_transmission_code].hash
        end
